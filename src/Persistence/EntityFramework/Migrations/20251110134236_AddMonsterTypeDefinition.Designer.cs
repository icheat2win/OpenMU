...
namespace MUnique.OpenMU.Persistence.EntityFramework.Migrations
{
    ...
    [Migration("20251110134236_AddMonsterTypeDefinition")]
    partial class AddMonsterTypeDefinition
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.AttributeRequirement", b =>
                {
                    ...
                    b.Property<int>("MinimumValuePerItemLevel")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CashShopCategory", "config");
                });
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopProduct", b =>
                {
                    ...
                    b.Property<byte>("ItemOptionLevel")
                        .HasColumnType("smallint");

                    b.Property<int>("PriceGoblinPoints")
                        .HasColumnType("integer");

                    b.Property<int>("PriceWCoinC")
                        .HasColumnType("integer");

                    b.Property<int>("PriceWCoinP")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CashShopTransaction", "data");
                });
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.Character", b =>
                {
                    ...
                    b.Property<Guid?>("CashShopStorageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.GameMapDefinition", b =>
                {
                    ...
                    b.Property<bool>("DisablePartySummon")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.ItemDefinition", b =>
                {
                    ...
                    b.Property<Guid?>("LearnableSkillId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PetLeadershipFormula")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("WearableSkillId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("LearnableSkillId");

                    b.HasIndex("SkillId");

                    b.HasIndex("WearableSkillId");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.MiniGameDefinition", b =>
                {
                    ...
                    b.Property<int>("BlessJewelDropCount")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SoulJewelDropCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.MonsterTypeDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<float>("AggroMultiplier")
                        .HasColumnType("real");

                    b.Property<int>("AttackPattern")
                        .HasColumnType("integer");
                    ...
                    b.Property<float>("DropRateMultiplier")
                        .HasColumnType("real");
                    ...
                    b.ToTable("MonsterTypeDefinition", "config");
                });
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopCategory", b =>
                {
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.GameConfiguration", null)
                        .WithMany("RawCashShopCategories")
                        .HasForeignKey("GameConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopProduct", b =>
                {
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopCategory", "RawCategoryObject")
                        .WithMany()
                        .HasForeignKey("CategoryObjectId");

                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.GameConfiguration", null)
                        .WithMany("RawCashShopProducts")
                        .HasForeignKey("GameConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("RawCategoryObject");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.CashShopTransaction", b =>
                {
                    ...
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.Account", null)
                        .WithMany("RawCashShopTransactions")
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.Character", b =>
                {
                    ...
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.ItemStorage", "RawCashShopStorage")
                        .WithOne()
                        .HasForeignKey("MUnique.OpenMU.Persistence.EntityFramework.Model.Character", "CashShopStorageId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.Navigation("RawCashShopStorage");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.ItemDefinition", b =>
                {
                    ...
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.Skill", "RawLearnableSkill")
                        .WithMany()
                        .HasForeignKey("LearnableSkillId");

                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.Skill", "RawSkill")
                        .WithMany()
                        .HasForeignKey("SkillId");

                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.Skill", "RawWearableSkill")
                        .WithMany()
                    ...
                    b.Navigation("RawLearnableSkill");

                    b.Navigation("RawSkill");

                    b.Navigation("RawWearableSkill");
                });
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.MonsterDefinition", b =>
                {
                    ...
                    b.HasOne("MUnique.OpenMU.Persistence.EntityFramework.Model.MonsterTypeDefinition", "RawMonsterType")
                        .WithMany()
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.Account", b =>
                {
                    ...
                    b.Navigation("RawCashShopTransactions");
            ...
            modelBuilder.Entity("MUnique.OpenMU.Persistence.EntityFramework.Model.GameConfiguration", b =>
                {
                    ...
                    b.Navigation("RawCashShopProducts");
